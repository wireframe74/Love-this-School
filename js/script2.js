...
function showHideContent(){
	if (jQuery('body').hasClass('standard')){
		if (jQuery('.standard .header_wrap').css('left') == '30px'){
			...
			jQuery('.standard .header_arrow').animate({left:'85px'}, 300, 'easeOutQuint', function(){
				...
				jQuery('.standard .header_wrap').animate({left:'30px'}, 700, 'easeOutQuint');
...
jQuery(document).ready(function(){ 
	...
	// SET VARIABLES TO USE WITH VALIDATON
		...
		var $referrer = jQuery('#enquiry_referrer').val();
		...
		if ($name != '' && $nameshort != true && $namelong != true && $email != '' && $emailerror != false && $subject != '' && $subjectshort != true && $subjectlong != true && $message != '' && $messageshort != true && $contactemail != '' && $contacturl != '' && $mywebsite != ''){
			jQuery.post($contacturl, 
				{type:'form', contactemail:$contactemail, name:$name, surname: $surname , email:$email, address: $address,  number: $number,    website:$url,  mywebsite:$mywebsite}, 
				function(data){
			...
			if ($number == ''){ 
				jQuery('#number').parent().find('div.form_error').hide(); 
				jQuery('#number').parent().find('div.defaulterror').show(); 
			} else if ($numbershort == true){ 
				jQuery('#number').parent().find('div.form_error').hide(); 
				jQuery('#number').parent().find('div.shorterror').show(); 
			} else if ($numberlong == true){ 
				jQuery('#number').parent().find('div.form_error').hide(); 
				jQuery('#number').parent().find('div.longerror').show(); 
			} else { 
				jQuery('#number').parent().find('div.form_error').hide(); 
			}
			
			if ($surname == ''){ 
				jQuery('#surname').parent().find('div.form_error').hide(); 
				jQuery('#surname').parent().find('div.defaulterror').show(); 
			} else if ($surnameshort == true){ 
				jQuery('#surname').parent().find('div.form_error').hide(); 
				jQuery('#surname').parent().find('div.shorterror').show(); 
			} else if ($surnamelong == true){ 
				jQuery('#surname').parent().find('div.form_error').hide(); 
				jQuery('#surname').parent().find('div.longerror').show(); 
			} else { 
				jQuery('#surname').parent().find('div.form_error').hide(); 
			}
