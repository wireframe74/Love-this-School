...
jQuery(document).ready(function(){ 
	...
	// SET VARIABLES TO USE WITH VALIDATON
		...
		if ($name != '' && $nameshort != true && $namelong != true && $email != '' && $emailerror != false  && $contacturl != '' && $mywebsite != ''){
			jQuery.post($contacturl, 
				{type:'form', contactemail:$contactemail, name:$name, surname: $surname , email:$email, address: $address,  number: $number,     mywebsite:$mywebsite}, 
				function(data){
