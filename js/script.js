...
jQuery('.toggle-button').click(function () {
    ...
    if (!positiveMargin) {
        var marginLeft = "750px";
        positiveMargin = true;
		 jQuery('#grav-form').fadeIn(2000);
    }
    else {
        var marginLeft = "320px";
        positiveMargin = false;
		 jQuery('#grav-form').hide();
...
/*
	jQuery('.toggle-button').toggle(function() { //fired the first time
  jQuery('#header').animate({width:"750px"});
  jQuery('#grav-form').fadeIn();
}, function() { // fired the second time 
 jQuery('#grav-form').fadeOut();
  jQuery('#header').animate({width:"320px"});
});
...
jQuery('.close-btn').click(function() { // fired the second time 
 jQuery('#grav-form').fadeOut();
  jQuery('#header').animate({width:"320px"});
});
...
function showHideContent(){
	if (jQuery('body').hasClass('standard')){
		if (jQuery('.standard .header_wrap').css('left') == '30px'){
			jQuery('.standard .header_wrap').animate({left:'-342px'}, 700, 'easeInQuint', function(){
			...
			jQuery('.standard .header_arrow').animate({left:'85px'}, 300, 'easeOutQuint', function(){
				...
				jQuery('.standard #middle').animate({left:'320px'}, 700, 'easeOutQuint', function(){
