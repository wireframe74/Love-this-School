...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<link rel='stylesheet' id='open-sans-css'  href='//fonts.googleapis.com/css?family=Open+Sans%3A300italic%2C400italic%2C600italic%2C300%2C400%2C600&#038;subset=latin%2Clatin-ext&#038;ver=3.9.1' type='text/css' media='all' /><!--[if lt IE 9]>
...
<!-- _________________________ Start Middle _________________________ -->
			<div id="middle">
				<div id="home">
					<h2 class="home">Contacts</h2>
				</div>
				<div id="content">
					<div class="entry">
						<p>Feel free to contact us and say hello. Required fields are marked</p>
						...
						<div class="contform">
							<form action="#" method="post" id="contactform">
								<div class="form_info">
									<div class="form_error defaulterror">You forgot to enter your name.</div>
									<div class="form_error shorterror">Entered name should not be shorter than 3 characters.</div>
									<div class="form_error longerror">Entered name should not be longer than 30 characters.</div>
								...
								<div class="form_info message_info">
									...
									<label for="message" class="message">Message<span> *</span></label>
									<textarea name="message" id="message" cols="28" rows="6" tabindex="7"></textarea>
								</div>
								<div><input type="hidden" value="http://www.lovethisschool.com.au/" id="contactwebsite" name="contactwebsite" /></div>
								<div><input type="hidden" value="chris@thosedigitalthoughts.com" id="contactemail" name="contactemail" /></div>
								
								<div><input type="hidden" value="http://www.lovethisschool.com.au/php/sendmail.php" id="contacturl" name="contacturl" /></div>
								<div>
